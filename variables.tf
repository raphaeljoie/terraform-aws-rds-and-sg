variable "name" {
  type = string
  description = "used as 'identifier', the name of the RDS instance. if omitted, Terraform will assign a random, unique identifier"
}
...
variable "db_name" {
  description = "The DB name to create. If omitted, no database is created initially. Used as 'name' parameter of the rds module"
  type        = string
  default     = null
}
